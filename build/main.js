(function(e, a) {
  ...
  \***********************/
        ...
        /***/ function(module, __webpack_exports__, __webpack_require__) {
          'use strict';
          eval(
            "__webpack_require__.r(__webpack_exports__);\n/* WEBPACK VAR INJECTION */(function(logger) {/* harmony import */ var _lib_util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../lib/util */ \"./src/lib/util.js\");\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (app => {\n  const cluster = process.env.CLUSTER_NAME || 'dc1';\n  [`/ui/${cluster}/kv/`, '/v1/kv/'].forEach(root => {\n    app.get(`${root}*`, Object(_lib_util__WEBPACK_IMPORTED_MODULE_0__[\"wrapError\"])(async (req, res) => {\n      let path = decodeURIComponent(req.path.substr(root.length));\n\n      if (path[path.length - 1] === '/') {\n        path = path.substr(0, path.length - 1);\n      }\n\n      const env = process.env[path];\n\n      if (typeof env !== 'undefined') {\n        logger.info(`Requested: ${path}, sent: ${env}`); // res.setHeader('Content-Type', 'application/json');\n\n        res.status(200);\n        res.send({\n          Value: env\n        }); // .send(JSON.stringify({\n        //     Value: env,\n        // }));\n      } else {\n        logger.info(`Requested: ${path}, but nothing found`);\n        res.status(404).send('not found');\n      }\n    }));\n  });\n});\n/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./src/lib/logger.js */ \"./src/lib/logger.js\")))\n\n//# sourceURL=webpack:///./src/api/kv.js?",
          );
